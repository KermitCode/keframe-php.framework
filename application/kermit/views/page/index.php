					...
					<table class="table table-bordered table-striped">
						...
						$i=1;foreach($this->pageData as $k=>$row){?>
							<tr>
								...
								<td><a href="<?php echo $this->makeUrl('/article/view',array('id'=>$row['id']));?>" target="_blank"><?php echo $row['ar_title'];?></a></td>
                                ...
                                <td><?php 
									echo "<a href='".$this->makeUrl('page/create',array('id'=>$row['id']))
				."'><button class='btn btn-success btn-small' type='button' >修改</button></a>&nbsp;&nbsp;";
									echo "<a href='".$this->makeUrl('page/delete',array('id'=>$row['id']))
