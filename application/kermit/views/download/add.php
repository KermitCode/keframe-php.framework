				<div class="span10">
					...
					<script src="<?php echo $this->imagesUrl;?>uploadify/jquery.uploadify.min.js"></script>
                    <link href="<?php echo $this->imagesUrl;?>uploadify/uploadify.css" rel="stylesheet">
					<form id="edit-profile" class="form-horizontal" method="post" action="<?php echo $this->makeUrl('download/fileadd'); ?>" onsubmit="return checkform()">
						<fieldset>
							<legend></legend>
                ...
                <script type="text/javascript">
					$(function() {
						$('#file_upload').uploadify({
							'buttonText':'选择文件',
							'swf'      : '<?php echo $this->imagesUrl;?>uploadify/uploadify.swf',
							'uploader' : "<?php echo $this->makeUrl('download/upfile'); ?>",
