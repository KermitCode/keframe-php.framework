...
<html lang="en"><!--<![endif]--> 
	...
	<body>
		<div id="login-page" class="container">
			...
			<form id="login-form" class="well" action="<?php echo $this->KE('keUrl')->makeUrl('kermit/login/login');?>" method="post">
                ...
                <img src="<?php echo $this->KE('keUrl')->makeUrl('kermit/login/code',array('k'=>rand(0,100000)));?>" style="vertical-align:middle;margin-top:-10px;" id="imgcode">
                </div><br>
                <button type="submit" class="btn btn-primary">点击登录</button>&nbsp;&nbsp;&nbsp;&nbsp;
                <button type="button" class="btn" onClick="$.changeCode();">更换验证码</button>
            </form>
		</div>
		<script src="<?php echo $this->getSet('imagesUrl');?>admindir/js/jquery.min.js"></script>
