                    ...
                    <div class="container">
                        ...
                        <div class="nav-collapse">
                            <ul class="nav pull-right">
                                <li><a href="#">管理员：<?php echo $this->keSession('adminer');?></a></li>
                                <li><a href="<?php echo $this->KE('keUrl')->makeUrl('kermit/login/quit');?>">退出</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
				...
				<div class="span2">
					<div class="well" style="padding: 0px 0;">
                        ...
                        <?php foreach($this->menuData as $name=>$row){?>
                            ...
                            <li<?php echo $r['c'];?>>
                            	<a href="<?php echo $this->KE('keUrl')->makeUrl($r['u']);?>">
