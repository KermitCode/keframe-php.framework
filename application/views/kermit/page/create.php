                ...
                <link rel="stylesheet" href="<?php echo $this->getSet('imagesUrl');?>kindeditor4.1/themes/default/default.css" />
				<script charset="utf-8" src="<?php echo $this->getSet('imagesUrl');?>kindeditor4.1/kindeditor-min.js"></script>
                <script charset="utf-8" src="<?php echo $this->getSet('imagesUrl');?>kindeditor4.1/lang/zh_CN.js"></script>
					<h3><?php echo $this->pageName;?></h3>
					<form id="edit-profile" class="form-horizontal" method="post" action="<?php echo $this->KE('keUrl')->makeUrl('kermit/page/pagesub'); ?>" onsubmit="return checkform()">
						<fieldset>
							<legend></legend>
                            ...
                            <div class="control-group">
								...
								<div class="controls">
									<?php echo $this->KE('keHtml')->radio('ar_tui',array(1=>'推荐',0=>'不推荐'),$this->pageData['ar_tui']);?>
								</div>
							</div>
                            <div class="control-group">
								<label class="control-label" for="input01">发表在哪类：</label>
								<div class="controls">
									<?php echo $this->KE('keHtml')->select('ar_cid',$this->category,$this->pageData['ar_cid']);?>
								</div>
							</div>
                            <div class="control-group">
                            ...
                            <script>
								KindEditor.ready(function(K) {
									K.create('textarea[name="ar_text"]', {
										autoHeightMode : true,
										uploadJson : '<?php echo $this->KE('keUrl')->makeUrl('kermit/page/upload');?>',
