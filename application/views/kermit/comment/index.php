					...
					<table class="table table-bordered table-striped">
						...
						$i=1;foreach($this->comData as $k=>$row){?>
							<tr>
								...
								<td><a href="<?php echo $this->KE('keUrl')->makeUrl('article/view',array('id'=>$row['com_arid']));?>" target="_blank"><?php echo $this->titleArr[$row['com_arid']];?></a></td>
                                <td><?php echo date('Y-m-d H:i:s',$row['com_time']);?></td>
                                <td><?php echo $row['com_ip'];?></td>
                                <td><?php 
									echo "<a href='".$this->KE('keUrl')->makeUrl('kermit/comment/delete',array('id'=>$row['id']))
