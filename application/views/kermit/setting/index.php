				<div class="span10">
					...
					<form id="edit-profile" class="form-horizontal" method="post" action="<?php echo $this->KE('keUrl')->makeUrl('kermit/setting/save');?>">
						<fieldset>
							<legend></legend>
                            <h4>网站基本信息设置：</h4>
							<div class="control-group">
								...
								<div class="controls">
									<?php echo $this->KE('keHtml')->radio('web_open',array(0=>'关闭',1=>'运行'),$this->setting['web_open']);?>
								</div>
							</div>
							<div class="control-group">
